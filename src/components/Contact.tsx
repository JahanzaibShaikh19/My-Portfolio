          ...
          <RevealOnScroll>
            <div className="section-panel contact-panel contact-form-panel p-5 md:p-6">
                ...
                <div>
                  ...
                  <div className="mb-5 flex items-center justify-between gap-3">
                    {errors.message ? (
                      ...
                      <p className="text-xs text-text-muted">Keep it rough — I can help shape the scope.</p>
                    )}
              ...
              <div aria-live="polite">
                {status === "success" && (
                  <div className="contact-success-card flex items-start gap-3 text-sm text-text-secondary">
                ...
                {status === "error" && (
                  <p className="mt-4 text-sm text-red-400">
                    Looks like something went wrong. Please try again or email me directly.
                  </p>
                )}
              </div>
            </div>
